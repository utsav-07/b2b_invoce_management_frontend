...
import FilterWithCusomerId from '../Services/FilterWithCusomerId';
          ...
          <div style={{ display: 'flex', height: '100%' }}>
            <div style={{ flexGrow: 1 }}>
              ...
              <DataGrid sx={{
                ...
                color: 'white'
              }} rowHeight={40} autoHeight rows={FilterWithCusomerId(dataHolder, search)} getRowId={row => row.sl_no} columns={HeadCells}
